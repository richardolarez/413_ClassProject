...
document.addEventListener("DOMContentLoaded", function() {
    let firstName=document.getElementById("First_name_PA");
    ...
    */
    ...
    function formValidate(){
        ...
        firstName.style.setProperty("border","1px solid #aaa");
    ...
    //Checking if first name is valid. It cannot be an empty string or contain a digit.
        ...
        result=redigit.exec(firstName.value);
        if(firstName.value.length==0 || result!=null ){
